get_rainfall <- function(level = 'municipality', panel = FALSE){
  ...
  if(level == "municipality"){
    ...
    dt <- openxlsx::read.xlsx("https://trello-attachments.s3.amazonaws.com/5ea83f462064047eed09f846/5ea83fc7d5707865983b4f14/2fe3829d60a70197d0b44337440348a2/PEECIPITACAO_1901_2019.xlsx")
  }
  if(level == 'state'){
    message('Please, wait for the data to download!')
    dt <- openxlsx::read.xlsx("https://trello-attachments.s3.amazonaws.com/5ea83f462064047eed09f846/5ea83fc7d5707865983b4f14/2fe3829d60a70197d0b44337440348a2/PEECIPITACAO_1901_2019.xlsx")
